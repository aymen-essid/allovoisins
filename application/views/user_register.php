...
<div id="body">
	<div class="container mt-5">
		...
		<?php echo form_open('api/user/register'); ?>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<textarea class="form-control" id="postalAddress" name="postalAddress"><?php echo set_value('postalAddress'); ?></textarea>
			</div>
			<div class="mb-3">
				<label for="professionalStatus" class="form-label">Professional Status</label>
				<input type="text" class="form-control" id="professionalStatus" name="professionalStatus" value="<?php echo set_value('professionalStatus'); ?>">
			</div>
